          ...
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <RevealSection delay={120}>
              <div className="space-y-5 text-base md:text-lg text-muted-foreground leading-relaxed" style={{ maxWidth: "65ch" }}>
                ...
                <p>Steev Hodgson, our founder, is an ICF-credentialed ADHD coach who has completed over 1,300 one-on-one coaching sessions. He is also an ADHD adult himself. After years of watching his teenage clients struggle between appointments — flooding with rejection sensitivity, paralyzed by homework, spiraling in the hallway between classes — he created the first version of DOSE himself, because nothing on the market met them where they actually were. Now the team has grown to 8 Proffesionals dedicated to building something meaningful for the ADHD Community.
